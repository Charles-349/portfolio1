...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 bg-base-100 text-base-content transition-all duration-300">
      <div className="max-w-7xl w-full flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        {/* Text */}
        <motion.div
          className="flex-1 text-center md:text-left"
        ...
        >
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            <Link
              to="/projects"
              className="px-6 py-3 bg-primary text-primary-content rounded-md hover:opacity-90 transition"
            >
              View Projects
            </Link>
            <Link
              to="/contact"
              className="px-6 py-3 border border-base-content rounded-md hover:bg-base-200 transition"
            >
              Contact Me
            </Link>
          </div>
        ...
        >
          <img
            src={profileIMG}
            alt="David"
            className="w-60 h-60 rounded-full object-cover border-4 border-primary shadow-lg"
          />
        </motion.div>
      </div>
    </section>
